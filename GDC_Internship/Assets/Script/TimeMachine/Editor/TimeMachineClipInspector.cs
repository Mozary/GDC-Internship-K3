		...
		if(!isMarker)
		{
			...
			switch(conditionType)
			{
                ...
                */
                ...
                case TimeMachineBehaviour.Condition.runningDialogue:
                    EditorGUILayout.HelpBox("The above action will be executed if playhead reach SetDialogue_x activation clip.", MessageType.Info);
                    EditorGUILayout.Space();
                    EditorGUILayout.PropertyField(conditionProp);
